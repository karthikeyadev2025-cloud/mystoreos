      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          {cycles.length > 1 && (
            <div style={{ marginTop: 18 }}>
              ...
              {offerOn && cycle !== 'monthly' && (
                <div style={{ marginTop: 12, display: 'inline-block', background: 'rgba(16,185,129,0.12)', border: '1px solid rgba(16,185,129,0.35)', color: 'var(--c-success)', borderRadius: 20, padding: '6px 16px', fontSize: 13, fontWeight: 800 }}>
        ...
        <div className="pricing-grid" style={{ display: 'grid', gap: 20 }}>
          {active.map((p, i) => {
            ...
            <motion.div key={p.id || i}
              ...
              {tp && <div style={{ color: 'var(--c-success)', fontSize: 12, fontWeight: 700, marginBottom: 4 }}>Save {tp.totalPct}% vs monthly</div>}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <button onClick={() => navigate('/pricing')}
            style={{ background: 'linear-gradient(135deg,var(--c-primary-light),var(--c-primary))', border: 'none', color: 'var(--c-surface)', padding: '14px 28px', borderRadius: 8, fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: "'Inter', system-ui, sans-serif" }}>
            View Full Pricing →
          </button>
          <button onClick={() => navigate('/register')}
            style={{ background: 'rgba(26,34,48,0.06)', border: '1px solid rgba(26,34,48,0.12)', color: 'var(--c-bg)', padding: '14px 24px', borderRadius: 12, fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: "'Inter', system-ui, sans-serif" }}>
