...
const css = `
  ...
  .ws-page{min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,var(--c-ink-surface),var(--c-primary),var(--c-ink-surface-2));padding:20px;font-family:var(--font-sans),sans-serif}
