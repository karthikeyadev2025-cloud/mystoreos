...
const FieldVanBilling = lazy(() => import('./pages/field/FieldVanBilling'));
          ...
          <BrowserRouter>
              ...
              <Routes>
                ...
                <Route path="/distributor/new-sale" element={
                  <PrivateRoute role="distributor">
                    <Suspense fallback={<DashboardSkeleton />}>
                      <ErrorBoundary fullPage><WideAppLayout><DirectSale /></WideAppLayout></ErrorBoundary>
                    </Suspense>
                  </PrivateRoute>
                } />
                <Route path="/field/diagnostics" element={
                  <PrivateRoute role="distributor">
                    <Suspense fallback={<DashboardSkeleton />}>
                      <ErrorBoundary fullPage><WideAppLayout><FieldDiagnostics /></WideAppLayout></ErrorBoundary>
                    </Suspense>
                  </PrivateRoute>
                } />
                ...
                <Route path="/field/activity" element={
                  <PrivateRoute role="distributor">
                    <Suspense fallback={<DashboardSkeleton />}>
                      <ErrorBoundary fullPage><WideAppLayout><FieldActivity /></WideAppLayout></ErrorBoundary>
                    </Suspense>
                  </PrivateRoute>
                } />
                <Route path="/field/reps" element={
                  <PrivateRoute role="distributor">
                    <Suspense fallback={<DashboardSkeleton />}>
                      <ErrorBoundary fullPage><WideAppLayout><FieldReps /></WideAppLayout></ErrorBoundary>
                    </Suspense>
                  </PrivateRoute>
                } />
                <Route path="/field/settlement" element={
                  <PrivateRoute role="distributor">
                    <Suspense fallback={<DashboardSkeleton />}>
                      <ErrorBoundary fullPage><WideAppLayout><FieldSettlement /></WideAppLayout></ErrorBoundary>
                    </Suspense>
                  </PrivateRoute>
                } />
                <Route path="/field/billing" element={
                  <PrivateRoute role="distributor">
                    <Suspense fallback={<DashboardSkeleton />}>
                      <ErrorBoundary fullPage><WideAppLayout><FieldVanBilling /></WideAppLayout></ErrorBoundary>
                    </Suspense>
                  </PrivateRoute>
                } />
