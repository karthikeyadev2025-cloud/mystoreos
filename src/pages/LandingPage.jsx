...
const BEATS = [
  ...
  { icon: '🚚', title: 'Restock Order', sub: 'Order from distributor in one tap', screen: ['National FMCG Supply', 'Atta Bulk  ₹1,950', 'Order sent ✓', 'Delivers: Tomorrow'], color: '#06b6d4' },
