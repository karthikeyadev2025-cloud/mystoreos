    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flex: 1 }}>
        <input type="color" value={value.startsWith('#') ? value : '#000000'} onChange={e => onChange(e.target.value)}
          style={{ width: '36px', height: '36px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', background: 'none', cursor: 'pointer', padding: '2px' }} />
        <input type="text" value={value} onChange={e => onChange(e.target.value)}
          style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#f8fafc', padding: '8px 12px', fontSize: '12px', fontFamily: 'monospace', outline: 'none', flex: 1 }} />
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ maxWidth: '760px' }}>
      <div style={{ marginBottom: '24px' }}>
        <h2 style={{ color: '#f8fafc', fontSize: '20px', fontWeight: 700 }}>Design & CSS</h2>
        <p style={{ color: '#94a3b8', fontSize: '13px', marginTop: '4px' }}>Customize platform colors, typography, and inject custom CSS</p>
      </div>

      <div style={S.card}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '20px' }}>
          <div style={{ background: 'rgba(244,63,94,0.15)', borderRadius: '10px', padding: '10px', display: 'flex', flexShrink: 0 }}><Palette size={18} color="#f43f5e" /></div>
          <div><div style={S.sectionTitle}>Color Presets</div><div style={S.sectionSub}>Quick-apply a color scheme</div></div>
        </div>
        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '20px' }}>
          {PRESETS.map(p => (
            <button key={p.name} onClick={() => applyPreset(p)} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 14px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.03)', color: '#f8fafc', fontSize: '12px', cursor: 'pointer', fontFamily: 'Outfit, sans-serif' }}>
        ...
        <div style={{ marginBottom: '16px', marginTop: '8px' }}>
          ...
          <input value={theme.cardBg} onChange={e => setTheme(t => ({ ...t, cardBg: e.target.value }))}
            style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#f8fafc', padding: '8px 12px', fontSize: '12px', fontFamily: 'monospace', outline: 'none', width: '100%' }} />
        </div>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <input value={theme.borderRadius} onChange={e => setTheme(t => ({ ...t, borderRadius: e.target.value }))}
            placeholder="12px" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#f8fafc', padding: '8px 12px', fontSize: '12px', fontFamily: 'monospace', outline: 'none', width: '200px' }} />
        </div>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          <button onClick={resetTheme} style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: '#94a3b8', borderRadius: '8px', padding: '10px 16px', cursor: 'pointer', fontFamily: 'Outfit, sans-serif', fontSize: '13px', display: 'flex', alignItems: 'center', gap: '6px' }}><RotateCcw size={14} />Reset Defaults</button>
        </div>
      </div>

      <div style={S.card}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '20px' }}>
          <div style={{ background: 'rgba(139,92,246,0.15)', borderRadius: '10px', padding: '10px', display: 'flex', flexShrink: 0 }}><Code size={18} color="#8b5cf6" /></div>
        ...
        <textarea
          ...
          style={{ background: '#0f172a', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#a5f3fc', padding: '14px', fontSize: '12px', fontFamily: 'monospace', outline: 'none', width: '100%', minHeight: '200px', resize: 'vertical', lineHeight: 1.6 }}
        />
        <div style={{ display: 'flex', gap: '10px', marginTop: '12px' }}>
          ...
          {customCSS && <button onClick={() => { setCustomCSS(''); updateConfigs({ customCSS: '' }); }} style={{ background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.3)', color: '#ef4444', borderRadius: '8px', padding: '10px 16px', cursor: 'pointer', fontFamily: 'Outfit, sans-serif', fontSize: '13px' }}>Clear CSS</button>}
        </div>
      </div>
    </div>
  );
