            ...
            {(claimMode || businessType === 'customer') && (
              <>
                <button
                  ...
                  style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: '#FFFFFF', border: '1.5px solid #E2E8F0', color: '#0F172A', padding: '12px', borderRadius: '10px', fontWeight: 700, fontSize: 14, cursor: 'pointer', marginBottom: 12 }}
                >
