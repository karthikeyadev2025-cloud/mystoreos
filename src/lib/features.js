...
export const PLAN_CAPS = {
  trial: {
    ...
    promoCode: false, advancedReports: false, aiForecasting: false,
  },
  starter: {
    ...
    staffAccounts: false, caPortal: false, tallyExport: false,
    multiDevice: false, customInvoiceFooter: false, loyaltyPoints: false, flashSales: false,
    promoCode: true, advancedReports: false, aiForecasting: false,
  },
  pro: {
    ...
    promoCode: true, advancedReports: true, aiForecasting: true,
  },
  enterprise: {
